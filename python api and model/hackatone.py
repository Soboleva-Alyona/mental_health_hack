...
df['emotion_label'] = np.where(df[emotions_list[0]] == 1, 1,
                                ...
                                np.where(df[emotions_list[7]] == 1, 8,
                                np.where(df[emotions_list[8]] == 1, 9,
                                np.where(df[emotions_list[9]] == 1, 10,
                                np.where(df[emotions_list[10]] == 1, 11,
                                np.where(df[emotions_list[11]] == 1, 12,
                                np.where(df[emotions_list[12]] == 1, 13,
                                np.where(df[emotions_list[13]] == 1, 14,
                                np.where(df[emotions_list[14]] == 1, 15,
                                np.where(df[emotions_list[15]] == 1, 16,
                                np.where(df[emotions_list[16]] == 1, 17,
                                np.where(df[emotions_list[17]] == 1, 18,
                                np.where(df[emotions_list[18]] == 1, 19,
                                np.where(df[emotions_list[19]] == 1, 20,
                                np.where(df[emotions_list[20]] == 1, 21,
                                np.where(df[emotions_list[21]] == 1, 22,
                                np.where(df[emotions_list[22]] == 1, 23,
                                np.where(df[emotions_list[23]] == 1, 24,
                                np.where(df[emotions_list[24]] == 1, 25,
                                np.where(df[emotions_list[25]] == 1, 26,
                                np.where(df[emotions_list[26]] == 1, 27,
                                np.where(df[emotions_list[27]] == 1, 28, 0))))))))))))))))))))))))))))
...
X_test_counts = count_vectorizer.transform(['I appreciate it, that is good to know. I hope I will have to apply that knowledge one day'])
